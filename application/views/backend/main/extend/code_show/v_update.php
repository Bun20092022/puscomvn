<div class="card">
	<div class="card-header">
		<h4 class="card-title">Chỉnh sửa nội dung code</h4>
	</div>
	<div class="card-body">
				...
				<div class="col-md-12 mb-3">
					...
					<div class="tab-content p-3 text-muted">
						<div class="tab-pane active" id="home" role="tabpanel">
							...
							<textarea class="form-control mb-3" rows="15" name="html_text"><?= $view['html_text'] ?></textarea>
						</div>
						<div class="tab-pane" id="profile" role="tabpanel">
							<label class="form-label">Nội dung CSS</label>
							<textarea class="form-control mb-3" rows="15" name="css_text"><?= $view['css_text'] ?></textarea>
						</div>
						<div class="tab-pane" id="messages" role="tabpanel">
							<label class="form-label">Nội dung Javacript</label>
							<textarea class="form-control mb-3" rows="15" name="javascript_text"><?= $view['javascript_text'] ?></textarea>
						</div>
					</div>
				</div>
				<div class="col-md-12 mb-3">
					<button class="btn btn-primary" type="submit" name="update_code">Chỉnh sửa code</button>
				</div>
			</div>
		</form>
	</div>
