		...
		<form action="" method="post">
			<div class="row">
				...
				<div class="col-md-12 mb-3">
						...
						<img src="<?= $view['link_img_right']; ?>" alt="" width="300">
					</div>
						<div class="col-md-12 mb-3">
							<label class="form-label">Thay thế hình ảnh</label>
							<div class="row">
								<div class="col-md-8">
									<input id="xFilePath1" name="link_img_right" type="text" size="60" class="form-control" value="<?= $view['link_img_right']; ?>">
								</div>
								<div class="col-md-4">
				...
				<div class="tab-content p-3 text-muted">
					...
					<div class="col-md-12 mb-3">
						<p class="form-label">Ảnh hiện tại</p>
						<img src="<?= $view['link_img']; ?>" alt="" width="300">
					</div>
						<div class="col-md-12 mb-3">
							<label class="form-label">Thay thế hình ảnh</label>
							<div class="row">
								<div class="col-md-8">
									<input id="xFilePath" name="link_img" type="text" size="60" class="form-control" value="<?= $view['link_img']; ?>">
								</div>
								<div class="col-md-4">
