	...
	<div class="card-body">
		<form action="" method="post">
			<div class="row">
				...
				<div class="col-md-12 mb-3">
					<label class="form-label">Hiển thị Demo</label>
					<select class="form-control" name="show_demo">
						<option value="0" <?php if($view['show_demo'] == 0){ echo 'selected'; } ?>>Ẩn Demo</option>
						<option value="1" <?php if($view['show_demo'] == 1){ echo 'selected'; } ?>>Hiện Demo</option>
					</select>
				</div>
				<div class="col-md-12 mb-3">
