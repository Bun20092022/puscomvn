            ...
            <form action="" method="post">
                  ...
                  <div class="tab-content p-3 text-muted">
                     ...
                     <?php foreach ($this->language as $value): ?>
                        ...
                        <div class="tab-pane <?php if($dem == 1){ echo 'active'; } ?>" id="tab<?= $value['id']; ?>" role="tabpanel">
                           ...
                           <input type="text" class="form-control" name="name_<?= $value['name_des']; ?>" required>
                        </div>
                     <?php endforeach ?>
                  </div>
               </div>
               <?php if($view_posts_setup['id'] == 1){ ?>
                  <div class="mb-3">
                     ...
                     <div class="row">
                        <div class="col-md-8">
                           <input id="xFilePath1" name="link_image" type="text" size="60" class="form-control">
                        </div>
                        <div class="col-md-4">
                  ...
                  <div class="mb-3">
                     ...
                     <input type="text" class="form-control" name="product_color" id="colorpicker-showinput-intial" value="#f46a6a" required>
                  </div>
               <?php } ?>
               <?php if($view_posts_setup['id'] == 3){ ?>
                  <div class="mb-3">
               ...
               <?php } ?>
               <button class="btn btn-primary" type="submit" name="add">Thêm <?= $view_posts_setup['product_setup_group'] ?></button>
            </div>
         </div>
      </div>
   </div>
