...
class Sliderimg extends MY_Controller {

	public function __construct()
	{
		parent::__construct();
		$this->main = 'backend/layout/v_main';
		$this->folder = 'backend/main/extend/sliderimg';
		$this->extend = 43;
	}
	...
	public function update_image($id)
	{
		if(isset($_POST['update'])){
			...
			redirect('backend/main/extend/image/update/'.$view['id_posts_extend']);
		}
    ...
    public function delete($id,$id_posts){
        ...
        redirect('backend/main/extend/image/update/'.$id_posts);
    }
}
